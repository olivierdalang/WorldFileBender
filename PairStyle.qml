...
<qgis version="2.9.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes/>
  <renderer-v2 attr=" abs(xat( 0 )-xat( -1 ))&lt;0.000001 AND  abs(yat( 0 )-yat( -1 ))&lt;0.000001" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="0" label="Moved"/>
      <category render="true" symbol="1" value="1" label="Pinned"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="78,20,155,255"/>
          <prop k="line_style" v="solid"/>
